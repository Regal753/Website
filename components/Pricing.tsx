        ...
        <div className="bg-slate-800/50 rounded-2xl p-8 md:p-12 border border-slate-700">
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-3">
              <span className="mt-1 w-6 h-6 rounded-full bg-violet-500/20 text-violet-400 flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
              <p className="text-slate-300 text-sm leading-relaxed">
                お問い合わせフォームから、ご相談内容をお送りください。現状の課題感やご希望をざっくりお書きいただければ大丈夫です。
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-1 w-6 h-6 rounded-full bg-violet-500/20 text-violet-400 flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
              <p className="text-slate-300 text-sm leading-relaxed">
                内容を確認後、必要に応じてオンラインでヒアリングを行います（30 分程度）。ここまで費用はかかりません。
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-1 w-6 h-6 rounded-full bg-violet-500/20 text-violet-400 flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
              <p className="text-slate-300 text-sm leading-relaxed">
          ...
          <div className="text-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-bold rounded-lg transition-all transform hover:scale-[1.02] shadow-lg"
            >
              <Send size={18} />
              まずは相談する
            </a>
