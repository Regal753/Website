  ...
  return (
    <section id={SectionId.HOME} className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px]h bg-blue-50/80 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight">
            <span className="block text-slate-900">運用を、</span>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-600">
              仕組みで加速する。
            </span>
          </h1>
